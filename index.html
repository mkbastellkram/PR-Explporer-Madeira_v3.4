...
<head>
  ...
  <title>PR Explorer Madeira · V3.4.5</title>
...
<div id="app">
  ...
  <header class="topbar">
    ...
    <div class="top-actions">
      <button id="locateBtn" class="glass-btn" title="Standort"><span class="cu cu-location"></span></button>
      <button id="fitBtn" class="glass-btn" title="Karte einpassen"><span class="cu cu-fit"></span></button>
      <button id="layerBtn" class="glass-btn" title="Layer"><span class="cu cu-layers"></span></button>
      <button id="settingsBtn" class="glass-btn" title="Einstellungen"><span class="cu cu-gear"></span></button>
    </div>
  </header>
  ...
  <section class="filter-rail" id="filterRail">
    ...
    <button class="filter-chip" id="resetFiltersBtn">Alle PR</button>
  ...
  <nav class="modebar" aria-label="Hauptnavigation">
    <button class="mode active" data-mode="map"><span class="cu cu-map"></span>Karte</button>
    <button class="mode" data-mode="journal"><span class="cu cu-list"></span>Journal</button>
    <button class="mode" data-mode="travel"><span class="cu cu-trip"></span>Reise</button>
    <button class="mode" data-mode="dashboard"><span class="cu cu-grid"></span>Dashboard</button>
  </nav>
  ...
  <section class="travel-panel hidden" id="travelPanel">
    ...
    <div class="travel-dates">
      <label>Reisebeginn <input id="travelStart" type="date"></label>
      <label>Reiseende <input id="travelEnd" type="date"></label>
    </div>
    <div id="travelDateHint" class="muted"></div>
  ...
  <section class="settings-panel hidden" id="settingsPanel">
    ...
    <div class="settings-grid">
      <button class="settings-card" data-open-layers><span class="cu cu-layers"></span><span>Karten & Layer</span><small>Basiskarte, OSM Hiking, GPX, KML, POI/Webcams</small></button>
      <button class="settings-card" data-fit-selected><span class="cu cu-fit"></span><span>Aktive PR einpassen</span><small>GPX + KML der aktiven PR</small></button>
      <button class="settings-card" data-reset-view><span class="cu cu-map"></span><span>Gesamtkarte</span><small>Alle gefilterten PRs anzeigen</small></button>
      <button class="settings-card" data-clear-selection><span class="cu cu-close"></span><span>Auswahl lösen</span><small>Karussell und Kontextmarker ausblenden</small></button>
    </div>
    <h4>Darstellung</h4>
